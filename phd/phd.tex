...
\chapter{Parameter Learning for Grammatical Models}
  ...
  \section{Learning Grammar Parameters with the EM Algorithm}
    ...
    \marginnote{The subsection ``Scale-dependent Dirichlet Prior''
      should have much of its material moved to the Models chapter,
      since it is largely about selecting an initially plausible set
      of parameters.}
